    ...
    <div className="w-full bg-white">
      <div className="container-base py-3 text-center">
        <a
          ...
          className="inline-flex items-center rounded-sm bg-white text-primary border border-primary px-3 py-2 text-sm font-medium shadow-md hover:bg-danger hover:text-primary-foreground hover:shadow-lg"
        >
